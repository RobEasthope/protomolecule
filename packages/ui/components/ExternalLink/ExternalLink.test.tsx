...
describe('ExternalLink', () => {
  ...
  it('renders link with undefined href but with children', () => {
    render(
      <ExternalLink href={undefined}>No Link</ExternalLink>
    );
  ...
  it('applies default hover styles', () => {
    render(
      <ExternalLink href="https://example.com">Hover Test</ExternalLink>
    );
  ...
  it('handles empty string href', () => {
    render(
      <ExternalLink href="">Empty Href</ExternalLink>
    );
  ...
  it('handles protocol-relative URLs', () => {
    render(
      <ExternalLink href="//example.com">Protocol Relative</ExternalLink>
    );
